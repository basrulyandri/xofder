...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-md-12">
                {!!Form::open(['route' => ['permission.update', $permission->id],'class' => 'form-horizontal','method' => 'POST'])!!}
                ...
                <div class='form-group{{$errors->has('label') ? ' has-error' : ''}}'>
                    ...
                    <div class='form-group{{$errors->has('name') ? ' has-error' : ''}}'>
                        ...
                        <div class="col-sm-10">
                          {!!Form::text('name_permssion',$permission->name_permission,['class' => 'form-control','placeholder' => 'Name of Permission','required' => 'true'])!!}
